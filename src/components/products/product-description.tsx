...
export default function ProductPage({ product,isLoading }: { product: Product,isLoading: boolean }) {
  return (
          ...
          <div className="flex flex-col-reverse">
            <div className="hidden mt-6 w-full max-w-2xl mx-auto sm:block lg:max-w-none">
              <div className="grid grid-cols-4 gap-6">
                {[1, 2, 3, 4].map((img) => (
                  <Skeleton key={img} className="h-24 rounded-md" />
                ))}
              </div>
            </div>
          ...
          <div className="mt-10 px-4 sm:px-0 sm:mt-16 lg:mt-0">
            ...
            <div className="mt-3 flex items-center">
              <div className="flex items-center">
                {[1, 2, 3, 4, 5].map((star) => (
                  <Skeleton key={star} className="h-5 w-5 mr-1 rounded-full" />
                ))}
              </div>
            ...
            <div className="mt-6 flex items-center">
              ...
              <Skeleton className="h-12 w-12 ml-4 rounded-full" />
              <Skeleton className="h-12 w-12 ml-4 rounded-full" />
            </div>
        ...
        <div className="mt-16 lg:mt-24">
          ...
          <div className="border-t border-b border-gray-200 py-10">
            <div className="lg:grid lg:grid-cols-12 lg:gap-x-8">
              ...
              <div className="lg:col-start-5 lg:col-span-8 mt-6 lg:mt-0">
